...
@section('Content')
    <div class="main-content position-relative max-height-vh-100 h-100">
                            ...
                            <ul class="nav nav-pills nav-fill p-1 bg-gray-300" role="tablist">
                                <li class="nav-item">
                                    <a class="btn bg-gradient-info mb-0 px-0 py-1 d-flex align-items-center justify-content-center"
                                        data-bs-toggle="modal" data-bs-target="#inputDataMapel">
                                        <i class="ni ni-fat-add"></i>
                                        <span class="ms-2">Tambah Data Mapel</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <!-- Modal Input Data Mapel -->
        <div class="modal fade" id="inputDataMapel" tabindex="-1" role="dialog" aria-labelledby="inputDataModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inputDataModalLabel">Masukkan Data Mata Pelajaran</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="formInputDataMapel" action="{{ route('operator.subject.create') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label for="nama_mapel">Nama Mata Pelajaran</label>
                                <input type="text" class="form-control" id="nama_mapel" name="nama_mapel" maxlength="100"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kode_mapel" name="kode_mapel"
                                    maxlength="20" placeholder="Masukkan kode mata pelajaran" required>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-round bg-gradient-info" form="formInputDataMapel">Simpan
                            Data</button>
                    </div>
                </div>
            </div>
