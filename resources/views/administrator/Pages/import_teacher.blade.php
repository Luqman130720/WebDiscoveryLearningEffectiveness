...
@section('Content')
    <div class="main-content position-relative max-height-vh-100 h-100">
                            ...
                            <ul class="nav nav-pills nav-fill p-1 bg-gray-300" role="tablist">
                                <li class="nav-item">
                                    <a class="btn bg-gradient-info mb-0 px-0 py-1 d-flex align-items-center justify-content-center"
                                        data-bs-toggle="modal" data-bs-target="#importDataGuru">
                                        <i class="ni ni-fat-add"></i>
                                        <span class="ms-2">Import Data Guru</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <!-- Modal Upload Data Guru -->
        <div class="modal fade" id="importDataGuru" tabindex="-1" role="dialog" aria-labelledby="importDataModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="importDataModalLabel">Upload Data Guru</h5>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('operator.teacher.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
        ...
        <script>
            window.onload = function() {
                ...
                @if (session('teacherImportSuccess'))
                    var importNotificationModal = new bootstrap.Modal(document.getElementById('teacherImportSuccess'));
        ...
        <div class="modal fade" id="teacherImportSuccess" tabindex="-1" role="dialog"
            aria-labelledby="teacherImportSuccessLabel" aria-hidden="true">
            <div class="modal-dialog modal-success modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h6 class="modal-title" id="teacherImportSuccessLabel">Success</h6>
                    ...
                    <div class="modal-body">
                        <div class="py-3 text-center">
                            ...
                            <p>{{ session('teacherImportSuccess') }}</p>
                        </div>
                    </div>
